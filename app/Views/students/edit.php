...
<body>
    <div class="container mt-5">
        <div class="header">
            <h2 class="mb-4">Sửa thông tin sinh viên:  
        ...
        <form action="index.php?action=update" method="POST">
            ...
            <div class="form-group">
                ...
                required value="<?= isset($student['ho_ten']) ? htmlspecialchars($student['ho_ten']) : '' ?>">
            </div>
            <div class="form-group">
                <label for="gioi_tinh">Giới tính</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gioi_tinh" id="gioi_tinh_nam" value="Nam" 
                ...
                <div class="form-check form-check-inline">
                    ...
                    <?= (isset($student['gioi_tinh']) && $student['gioi_tinh'] === 'Nữ') ? 'checked' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="khoa_id" name="khoa_id">
                    ...
                    <?php foreach ($faculties as $faculty): ?>
                        ...
                        <?= (isset($student['khoa_id']) && (string)$student['khoa_id'] === (string)$faculty['id']) ? 'selected' : '' ?>>
